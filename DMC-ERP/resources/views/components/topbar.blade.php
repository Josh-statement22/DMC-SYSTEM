<header class="h-16 bg-white/70 border-b shadow-sm flex items-center justify-between px-8 backdrop-blur">
    ...
    <div class="relative">
        ...
        <div id="dropdown" class="absolute right-0 mt-3 w-48 bg-white rounded-2xl shadow-xl border z-50 opacity-0 scale-95 invisible transition">
